...
Checked against the current [rules dialog](../../src/ui/shared/Rules.tsx),
[rules engine](../../src/game/engine/resolve.ts), and
[card, relic, enemy, and event definitions](../../src/game/content).
